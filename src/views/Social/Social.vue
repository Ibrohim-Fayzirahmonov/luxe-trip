<template>
    ...
    <div>
      <a-modal cancelText="Bekor qilish" okText="Qo'shish" v-model:open="open" width="1000px" title="Ijtimoiy tarmoq qo'shish"
        @ok="handleOk">
        <div class="grid">
          <Input required placeholder="Tarmoqning nomini kiriting" label="Tarmoqning nomi" class="mb-4" />
          <Input type="text" required placeholder="Tarmoq havolasini kiriting" label="Tarmoq havolasi"
            class="mb-4" />
        </div>
      </a-modal>
    </div>
    ...
    <div>
      ...
      <Table striped hoverable class="mt-4">
        <table-head>
          <table-head-cell>Tarmoq nomi</table-head-cell>
          <table-head-cell>@ linki</table-head-cell>
        ...
        <table-body>
          <table-row v-for="el in 10" :key="el">
            <table-cell>Telegram</table-cell>
            <table-cell>@luxtrip</table-cell>
  
            <table-cell>
              <Button gradient="blue">Tahrirlash</Button>
            </table-cell>
            <table-cell>
              <Button gradient="red" class="relative lg:-left-[164px]">O'chirish</Button>
            </table-cell>
          </table-row>
        </table-body>
      </Table>
