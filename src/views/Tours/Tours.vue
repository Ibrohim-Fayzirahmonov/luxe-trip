<template>
    ...
    <div>
        <a-modal cancelText="Bekor qilish" okText="Qo'shish" v-model:open="open" width="1000px" title="Tur qo'shish"
            @ok="handleOk">
            <div class="grid">
                <Input required placeholder="Tur nomini kiriting" label="Tur nomi" class="mb-4" />
                <h3>Tur haqida ma'lumot kiriting</h3>
                ...
                <Input type="text" required placeholder="Tur manzilini kiriting" label="Tur manzili" class="mb-4" />
                <Input type="number" required placeholder="Tur narxini kiriting" label="Tur narxi" class="mb-4" />
                <div class="date-select">
                    <a-space direction="vertical" :size="12">
                        <h3>Tur sanalarini belgilang</h3>
                        <a-range-picker :show-time="{ format: 'HH:mm' }" format="YYYY-MM-DD HH:mm"
                            :placeholder="['Boshlanadigan vaqti', 'Tugash vaqti']" @change="onRangeChange"
                            @ok="onRangeOk" />
                    </a-space>
                </div>
            </div>
    ...
    <div>
        ...
        <Table striped hoverable class="mt-4">
            <table-head>
                <table-head-cell>Tur Nomi</table-head-cell>
            ...
            <table-body>
                <table-row v-for="el in 10" :key="el">
                    ...
                    <table-cell>
                        <Button gradient="red">O'chirish</Button>
                    </table-cell>
                    <table-cell>
                        <Button gradient="blue" class="relative lg:-left-24">Tahrirlash</Button>
                    </table-cell>
                </table-row>
            </table-body>
        </Table>
